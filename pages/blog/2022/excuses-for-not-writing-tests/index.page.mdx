...
Therefore, the myth that automated testing is _"time-consuming"_ is nothing but a fallacy because no one takes into account the cost and time of manually (re)testing over and over and over again.
...
So, I don't have any counterarguments here. However, I'm arguing if the reason for maintaining extra code is powerful enough to refuse the practice entirely.
...
Treating testing as a subtask of the development effort ensures us that we take the necessary time to do it.
...
**We only need to start. And play the game frequently. The rest will follow.**
