...
Thinking about it, many CSS preprocessors features are focused on **avoiding code duplication**. For instance, _variables_ allow us to re-use concrete values, while _mixins_ enable us to re-use entire blocks of CSS rules.
