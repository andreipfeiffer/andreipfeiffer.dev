...
- **Refactoring CSS code is not safe** because the tooling doesn't help to highlight syntax errors when renaming CSS class names or removing them. Consequently, developers will be afraid to touch or modify any existing code, ultimately leading to [code rot](https://en.wikipedia.org/wiki/Software_rot).
