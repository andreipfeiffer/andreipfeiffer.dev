...
During the <LinkTo part={CURRENT_PART - 1} />, we've set the stage for this chronicle. We've covered what we usually consider scalability concerns, in a broad sense. Now, it's time to turn our attention to the ones related to CSS.
