...
- [**An overview**](#overview) of Atomic CSS to highlight its core principles.
- [**Utility CSS classes**](#utility-css-classes), which comprise the content of an Atomic CSS approach.
...
Whether we like it or not, the truth is that Atomic CSS solves most of the problems of semantic CSS, namely code duplication, specificity, increasing code output, or complex selectors, just to name a few. Therefore, Atomic CSS proves to be a valid alternative to Semantic CSS.
