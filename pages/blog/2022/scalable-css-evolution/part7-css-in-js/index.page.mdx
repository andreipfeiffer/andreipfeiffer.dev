...
<Figure
  caption={
    "Simplified overview of how CSS-in-JS libraries with runtime stylesheets typically work"
  }
>
  <ThemedImg
...
<Figure
  caption={
    "Simplified overview of how CSS-in-JS libraries with Static CSS extraction work"
  }
>
  <ThemedImg
...
<Figure caption={"Simplified overview of how Atomic CSS-in-JS libraries work"}>
  <ThemedImg
...
<Subheading>Static &amp; Atomic CSS-in-JS</Subheading>
...
- Development experience of CSS-in-JS;
- Static CSS file caching;
- Atomic CSS small file size, in contrast with Semantic CSS.

<br />

Could this be the ultimate solution to CSS authoring? The theory indeed supports this claim. We'll have to see if the practice also supports the hypothesis as the future unfolds.
...
- **Variables** and **contextual styles**, like the rule nesting and parent selector, rendering CSS preprocessors obsolete.
