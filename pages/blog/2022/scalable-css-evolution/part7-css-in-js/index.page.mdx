...
We won't be analyzing any particular library as their APIs differ quite a bit. Instead, we'll focus on _CSS-in-JS as a paradigm_, looking at its fundamental principles and key features to understand the underlying technology. Here's what we'll cover next:
...
- [**CSS-in-JS criticism**](#criticism) despite its versatility and potential.
...
Besides the core features previously noted, CSS-in-JS solves other problems as well, beyond what CSS Modules or CSS processors can achieve:
...
Depending on the library's support, the imported styling function will receive the CSS styles as input, either a **JavaScript Object** or a **Tagged Template** string.
...
<Note title="Performance considerations">
  Fewer transferred bytes don't automatically imply faster
