...
The key takeaway is that **related variables should stay together**. Adding an empty line between these groups helps, even more, the readability of the code.
