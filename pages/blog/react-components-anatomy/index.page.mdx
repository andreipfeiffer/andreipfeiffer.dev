...
The first group of imports contains the **external or 3rd party dependencies**. These are the ones that we'll include in the `package.json` file and use absolute path imports.
