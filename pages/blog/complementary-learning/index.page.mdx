...
<Note>
  ...
  , but high{" "}
  <a href="https://en.wikipedia.org/wiki/Effectiveness"> effectiveness</a>.
  <br />
  <br />
  All other types of teaching are primarily one-way communication because it's practically
  impossible to have dialogs with everybody in the audience, thus being highly efficient
  but less effective.
</Note>
