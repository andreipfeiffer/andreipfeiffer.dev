...
- Whenever a teammate add any code to the repository we're working on, I **look at the commits**. It helps me stay up-to-date with the code updates, while also practicing code reading.
