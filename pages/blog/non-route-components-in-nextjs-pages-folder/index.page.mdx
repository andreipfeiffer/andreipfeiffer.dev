...
export const meta = {
  title: "Non-route components in Next.js pages folder",
  date: "2021-06-04",
...
## Distinguishing between pages and components
...
With this setting, we can co-locale the subcomponents specific to a single page, by moving them in the same folder:
