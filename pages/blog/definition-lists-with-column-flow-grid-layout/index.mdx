...
In this post, we'll examine various implementations for the layout displayed below, using both `flex` and `grid`, debating the robustness of each approach. The layout contains a horizontal list of 3 key-value pairs, the values being displayed beneath the labels.
...
This approach works, the content is displayed as needed. However, it has a pretty big flaw, because the markup doesn't say anything about the **semantics** of the content.
