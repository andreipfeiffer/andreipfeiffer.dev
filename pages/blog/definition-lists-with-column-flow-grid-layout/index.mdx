...
import { ListFlex, ListGrid } from "./index.tsx";
...
<Figure
  ...
  caption={
    <>
      3 key-value pairs implemented using a grid layout with the default{" "}
      <strong>grid-auto-flow:&nbsp;row</strong>, which breaks the visual result
    </>
  }
>
  <ListGrid flow="row" />
...
<Figure
  ...
  caption={
    <>
      3 key-value pairs implemented using a grid layout with{" "}
