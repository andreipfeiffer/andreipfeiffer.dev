...
But, for this to work, we must have a **separate `.css` file for each component**. However, this makes perfect sense, because a component should have all its concerns grouped together: HTML markup, JS behavior, and CSS styling.
...
<p>
  ...
  anymore, which brings benefits that were not possible before:
</p>

- easily figuring out where are the styles defined;
- eliminating unused styles when the component is not imported anymore.
