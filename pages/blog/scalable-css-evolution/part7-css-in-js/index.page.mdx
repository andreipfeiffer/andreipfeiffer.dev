...
It's worth mentioning that styles encapsulation was also one of the core goals of CSS-in-JS. However, CSS-in-JS means much more than just styles encapsulation. In this article we'll take a closer look at [**dead code elimination**](#dead-code-elimination) and how to [**easily share design tokens**](#shared-design-tokens).
