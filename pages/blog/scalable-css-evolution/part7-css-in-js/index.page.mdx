...
<Figure background={"#fff"} width="grid">
  <Image
    ...
    width="1920"
    height="885"
    alt="Timeline of scalable CSS evolution, highlighting major CSS-in-JS milestones"
  />
</Figure>
...
- **Avoiding zombie code** is mainly a consequence of having explicit dependencies because every component defines or imports its own styles. Thus, when we remove the component or don't import it anymore, the styles with also be ignored during bundling.
...
However, what what _is true_ is that a few libraries like [Radium](https://formidable.com/blog/2019/radium-maintenance/) and [Glamor](https://github.com/threepointone/glamor) used inline styles, but both have been discontinued.
