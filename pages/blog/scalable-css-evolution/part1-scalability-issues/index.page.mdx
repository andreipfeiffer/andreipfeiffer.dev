...
<p>
  In <LinkTo part={3} />, we'll see how tools with support for contextual styles
...
<Note>
  ...
  on CSS selector definition and is commonly displayed as a triad like{" "}
  <code>(1,3,2)</code>.
</Note>
...
<p>
  ...
  zombie code, successfully removing unused CSS code.
</p>
...
Similarly, CSS is also very relaxed. There never was a strict parser for CSS. So, we got used to the unsafe nature of HTML, CSS, and JavaScript. We had to, as there was no alternative.
