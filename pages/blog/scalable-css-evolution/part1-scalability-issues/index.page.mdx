...
Generally speaking, when we talk about _software scalability_, we look at **how software behaves when significantly increasing its size**.
...
However, _using globals as a practice_ within a team of several developers, working on a long-term project that spans over many years, will undoubtedly become a **substantial scalability problem**, sooner or later.

<br />

Now, each of us has our own definition of _"what a large project is"_ to figure out when these scalability issues might start to surface. From my own experience, CSS scalability problems become visible:
...
Before going any further to discuss the scalability solutions, we must understand the issues they're trying to solve. So, let's take a look at some of the most concerning problems when we talk about CSS scalability and maintainability:
