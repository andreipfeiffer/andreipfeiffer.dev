...
Last time I checked, [foreseeing](<https://en.wikipedia.org/wiki/Foresight_(psychology)>) future needs is very debatable. My own past experiences strongly support we are generally bad when making predictions.
...
// 👍 GOOD: less structure dependent
.main_menu .link {}

// ✅ BETTER: using a single class
.main_menu_link {}
```
<!-- prettier-ignore-end -->
