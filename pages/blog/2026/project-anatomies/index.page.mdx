...
With this approach, all the files of a single domain/entity/concept/feature are colocated in the same folder. [Colocation](https://alexmoldovan.dev/code-bites/colocation-is-king), as a general approach, provides better maintainablity on the long term for large-scale projects.
