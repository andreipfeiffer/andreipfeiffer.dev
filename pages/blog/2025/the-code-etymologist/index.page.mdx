...
One possible explanation for missing documentation is the practice of **agile software development**. Its primary values are defined on the homepage of the [Manifesto of Agile Software Development](https://agilemanifesto.org/), and the first two of them are:
