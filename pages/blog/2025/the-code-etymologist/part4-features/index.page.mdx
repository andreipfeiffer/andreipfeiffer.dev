...
SRS documents are definitely mandatory before development. But on the long term, they are non-trivial to maintain. And these documents should be reliable, developers and testers should be able to use them and understand how the product works. The question is **_What level of detail should be used to describe the specifications?_**

- We can maintain a **superficial list** containing only the use cases with their acceptance criteria, skipping the test cases and corner cases. This might be easier to digest, but lacks some details.
