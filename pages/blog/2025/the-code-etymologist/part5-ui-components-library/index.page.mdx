...
These are all built-in and out-of-the-box features. Additionally, there are plenty of [addons](https://storybook.js.org/addons) that we can use, such as Light/Dark theming, Viewport controls, Accessibility checks, and many many more.
