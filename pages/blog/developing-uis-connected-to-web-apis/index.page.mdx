...
- Using a **fake API** works great for prototyping or during early development stages when we don't have a fully working web API, but it could also be useful to bypass complex infrastructure or difficult to reach application states.
